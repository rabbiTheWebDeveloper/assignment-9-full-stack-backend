...
router.post("/addProducts", imageUpload_1.default.single('image'), AuthVerifyMiddleware_1.auth, product_controller_1.createProduct);
router.post("/product-update/:id", imageUpload_1.default.single('product_image'), product_controller_1.updateProduct);
router.get("/product-delete/:id", AuthVerifyMiddleware_1.auth, product_controller_1.productDelete);
